...
const SignIn = ({toggleOverlay, onSignUp}) => {
    // Schema dùng để validate form với Yup
    ...
    return (<form onSubmit={formik.handleSubmit} className={`${styles.c}`}>
                ...
                <div className={`${styles.c__form}`}>
                    <div className={`${styles.c__form_group}`}>
                        ...
                        {formik.touched.email && formik.errors.email ? (
                            <div className={`${styles.c__error}`}>{formik.errors.email}</div>) : null}
                    </div>
                    <div className={`${styles.c__form_group}`}>
                        <input
                            type="password"
                        ...
                        {formik.touched.password && formik.errors.password ? (
                            <div className={`${styles.c__error}`}>{formik.errors.password}</div>) : null}
